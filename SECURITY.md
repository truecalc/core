...
1. Go to the [Security tab](https://github.com/truecalc/core/security).
2. Click **Report a vulnerability**.
3. Fill in as much detail as you can — affected version, a minimal
   reproduction (e.g. the formula and input that triggers the issue), and
