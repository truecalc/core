...
pub fn register_text(registry: &mut Registry) {
    ...
    registry.register_eager("MIDB",        midb::midb_fn,              FunctionMeta { category: "text", signature: "MIDB(text, starting_at, num_bytes)",              description: "Substring from a character position, limited to N bytes" });
