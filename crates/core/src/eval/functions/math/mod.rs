...
pub fn register_math(registry: &mut Registry) {
    ...
    registry.register_lazy("COUNTUNIQUE",countunique::countunique_lazy_fn,  FunctionMeta { category: "math",        signature: "COUNTUNIQUE(value1, ...)",                              description: "Count unique distinct values" });
