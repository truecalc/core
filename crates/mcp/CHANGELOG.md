...
- *(mcp)* add npm downloads badge to README
...
- *(mcp)* ship truecalc-mcp via npx as @truecalc/mcp
...
- Merge pull request #817 from truecalc/feat/800-mcp-binary-matrix
- *(mcp)* extend release binary matrix to 5 platforms, add cargo-binstall support

## [7.0.5](https://github.com/truecalc/core/compare/truecalc-mcp-v7.0.4...truecalc-mcp-v7.0.5) - 2026-08-05
